...
An existing `CLAUDE.md` is not always hand-authored, and writing over a generated or tool-owned one produces work that disappears silently. Establish the ownership map before drafting: [`file-ownership.md`](file-ownership.md).
